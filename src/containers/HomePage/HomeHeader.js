                ...
                <div className='home-header-container'>
                    <div className='home-header-content'>
                        ...
                        <div className='right-content'>
                            ...
                            <div className={language === LANGUAGES.VI ? 'languge-vi active' : 'language-vi'}><span onClick={()=> this.changeLanguage(LANGUAGES.VI)}>VN</span></div>
                            <div className={language === LANGUAGES.EN ? 'languge-en active' : 'language-en'}><span onClick={()=> this.changeLanguage(LANGUAGES.EN)}>EN</span></div>
                        </div>
                    </div>
                </div>
                <div className='home-header-banner'>
                    ...
                    <div className='content-down'>
                        <div className='options'>
                            ...
                            <div className='option-child'>
                                <div className='icon'><i className="fab fa-grunt"></i></div>
